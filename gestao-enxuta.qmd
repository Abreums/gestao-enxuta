...
- Ohno queria que o trabalhador fosse capaz de diferenciar o "trabalho verdadeiro" de "movimentação".
...
- A forma mais efetiva de identificar o "trabalho verdadeiro" da "movimentação" é através da participação direta no local de trabalho (Gemba).
:::

::: {.column style="flex: 1; display: flex; flex-direction: column; justify-content: center; align-items: right; gap: 10px; text-align: right;"}
